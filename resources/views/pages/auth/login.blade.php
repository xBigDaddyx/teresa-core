    ...
    <div class="flex flex-col items-stretch justify-center w-screen min-h-screen py-10 sm:items-center">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="text-sm leading-5 text-center text-gray-600 dark:text-gray-400 space-x-0.5">
                <span>Or</span>
                <x-ui.text-link href="{{ url('/auth/register') }}">create a new account</x-ui.text-link>
            </div>
        </div>
                ...
                @volt('auth.login')
                    <form wire:submit="authenticate" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between mt-6 text-sm leading-5">
                            ...
                            <x-ui.text-link href="{{ url('/auth/password/reset') }}">Forgot your password?</x-ui.text-link>
                        </div>
