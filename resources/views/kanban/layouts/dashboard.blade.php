...
<body class="antialiased h-screen bg-neutral-100 bg-dots">

    <x-toast />

    <div class=" overflow-hidden relative">
        <div class="fixed top-0 footer items-center p-4 bg-neutral text-neutral-content">
            @include('kanban.layouts.dashboard-legend')
        </div>
        <!-- <header class="mt-24 pt-10">
            @include('kanban.layouts.dashboard-header')
        ...
        <footer class="fixed bottom-0 footer items-center p-4  text-neutral-content">
            @include('kanban.layouts.dashboard-footer')
        </footer>
    </div>
