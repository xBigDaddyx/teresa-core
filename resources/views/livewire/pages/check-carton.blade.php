    ...
    <div class="max-w-2xl mx-auto card lg:card-side bg-base-100 shadow-xl">
        ...
        <div class="card-body">
            ...
            <x-form d="boxCheck" wire:submit="check">
                <x-input label="Carton box barcode" placeholder="" icon="o-qr-code" hint="Check carton box is available or not." wire:model="boxForm.box_code" autofocus autocomplete="off" />
                ...
                <x-select label="Carton Number" option-value="carton_number" option-label="carton_number" icon="o-pencil-square" :options="$carton_numbers" wire:model="extraForm.selectedCartonNumber" inline />
                @endif
                @endif
