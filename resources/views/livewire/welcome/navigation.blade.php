<header
    ...
    <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-extrabold dark:text-white text-primary-500" href="#"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <div class="flex items-center gap-x-2 sm:ml-auto">
                    @auth
                        <a class="flex items-center gap-x-2 font-medium text-gray-500 hover:text-primary-600 sm:border-l sm:border-gray-300 sm:my-6 sm:pl-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-primary-500"
