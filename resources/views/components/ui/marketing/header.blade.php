        ...
        <div class="relative z-50 flex items-stretch space-x-3 text-neutral-800">
            ...
            @auth
                <div class="flex items-center w-auto">
                    <x-ui.button type="primary" submit="true" tag="a" href="{{ url('/dashboard') }}">View Dashboard</x-ui.button>
                </div>
            @else
                <div class="flex items-center w-auto">
                    <x-ui.button type="secondary" submit="true" tag="a" href="{{ url('/auth/login') }}">Login</x-ui.button>
                </div>
                <div class="flex items-center w-auto">
                    <x-ui.button type="primary" submit="true" tag="a" href="{{ url('/auth/register') }}">Sign Up</x-ui.button>
                </div>
            @endauth
