...
class ValidationOutputChart extends ApexChartWidget
{
    ...
    protected function getFormSchema(): array
    {
        return [
            ...
            DatePicker::make('period_end')
                ->default(Carbon::now()),
            Select::make('buyer')
                ->options(fn (): array => Buyer::whereBelongsTo(Filament::getTenant())->pluck('name', 'id')->toArray()),
    ...
    protected function getOptions(): array
    {
        ...
        foreach ($period as $key => $date) {
            ...
            $series1->push((string)$cartonBoxRepository->Output($date, Filament::getTenant()->id, $this->filterFormData['buyer']));
        }
