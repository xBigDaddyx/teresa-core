...
class SendRequestApprovalNotification extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Action Required: Your Approval Needed for Request Form',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.purchase.request.approval',
            with: [
